...
<!--                   <div class="row form-group">
                  ...
                  <div class="col-md-4">
                        <input value="<?= set_value('nama'); ?>" type="text"  class="form-control">
...
<!-- 
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama'); ?>" name="nama" id="id_user" type="text" class="form-control" placeholder="Nama Barang...">
                        <?= form_error('id_user', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
 -->
                 
                <div class="row form-sgroup">
                    <label class="col-md-4 text-md-right" for="id_user">Penjual</label>
                    <div class="col-md-4">
