        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('penjual/barang') ?>" class="btn btn-sm btn-primary btn-icon-split">
                            <span class="icon">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-primary" href="<?= base_url('penjual/jenis/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-primary" href="<?= base_url('penjual/satuan/add'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
