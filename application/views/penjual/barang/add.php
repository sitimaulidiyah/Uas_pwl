        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_masuk">ID Transaksi Barang</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_masuk', date('Y-m-d')); ?>" name="tanggal_masuk" id="tanggal_masuk" type="date" class="form-control date" placeholder="Tanggal Masuk...">
                        <?= form_error('tanggal_masuk', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_user">Penjual</label>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-primary" href="<?= base_url('penjual/barang/tambah'); ?>"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="file">Image</label>
                    <div class="col-md-4">
                        <input value="<?= set_value('image'); ?>" type="file">
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="jumlah_masuk">Jumlah</label>
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('jumlah_masuk'); ?>" name="jumlah_masuk" id="jumlah_masuk" type="number" class="form-control" placeholder="Jumlah...">
                            <div class="input-group-append">
