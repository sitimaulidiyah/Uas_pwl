...
<div class="row justify-content-center mt-5 pt-lg-5">
    ...
    <div class="col-xl-5 col-lg-5 col-md-9">
        ...
        <div class="card o-hidden border-2 shadow-lg">
            <div class="card-body p-lg-6 p-6">
                <div class="p-4">
                    <div class="text-center mb-4">
                        <h1 class="h4 text-gray-900">Penyediaan Jasa</h1>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <input value="<?= set_value('alamat'); ?>" type="text" name="alamat" class="form-control form-control-user" placeholder="Alamat">
                    ...
                    <div class="text-center mt-4">
                        <a class="small" href="<?= base_url('penjual/auth') ?>">Sudah punya akun? Login</a>
                    </div>
                    <?= form_close(); ?>
