...
<body class="animsition">
        ...
        <div class="wrap_menu">
          <nav class="menu">
            <ul class="main_menu">
              ...
              <li>
                <a href="gallery">Tentang Kami</a>
              </li>

              <li>
                <a href="ketentuan">Ketentuan & Syarat</a>
              </li>
              <li>
  ...
  <!-- Slide1 -->
  <div class="news" style="background: #d3d3d3">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
            ...
            <div class="news_item">
              <div class="news_image_container">
                 <div class="news_text">
                  ...
                  <p style="color:black; justify">1.&nbsp;&nbsp;&nbsp;Surat Izin Usaha Resmi.</p>
                  <p style="color:black; justify">2.&nbsp;&nbsp;&nbsp;Memiliki Kemampuan Untuk Menandatangani Kontrak Pengadaan Atau Pelepasan Assets</p>
                  &nbsp;&nbsp;&nbsp;Perusahaan </p>
                  <p style="color:black; justify">3.&nbsp;&nbsp;&nbsp;Bukti Pembayaran Pajak </p>
                  <p style="color:black; justify">4.&nbsp;&nbsp;&nbsp;Melampirkan SPK (Surat Perjanjian Kemitraan)</p>
                  <p style="color:black; justify">5.&nbsp;&nbsp;&nbsp;Tidak Masuk Daftar Hitam </p>
                  <p style="color:black; justify">6.&nbsp;&nbsp;&nbsp;Tidak Membuat Pernyataan Palsu </p>
