...
<body class="animsition">
 ...
 <!-- Title Page -->
  <section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(<?php echo base_url() ?>assets/depan/images/ananda6.jpg);">
      ...
      <div class="row">
        <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
          ...
          <div class="block1 hov-img-zoom pos-relative m-b-30">
            <img src="<?php echo base_url() ?>assets/depan/images/banner-02.jpg" alt="IMG-BENNER">
          ...
          <!-- block1 -->
          <div class="block1 hov-img-zoom pos-relative m-b-30">
            <img src="<?php echo base_url() ?>assets/depan/images/banner-05.jpg" alt="IMG-BENNER">
        ...
        <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
          <!-- block1 -->
          <div class="block1 hov-img-zoom pos-relative m-b-30">
            <img src="<?php echo base_url() ?>assets/depan/images/banner-03.jpg" alt="IMG-BENNER">
          ...
          <!-- block1 -->
          <div class="block1 hov-img-zoom pos-relative m-b-30">
            <img src="<?php echo base_url() ?>assets/depan/images/banner-07.jpg" alt="IMG-BENNER">
        ...
        <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
          <!-- block1 -->
          <div class="block1 hov-img-zoom pos-relative m-b-30">
            <img src="<?php echo base_url() ?>assets/depan/images/banner-04.jpg" alt="IMG-BENNER">
          ...
          <div class="block2 wrap-pic-w pos-relative m-b-30">
            <img src="<?php echo base_url() ?>assets/depan/images/icons/bg-01.jpg" alt="IMG">
      ...
      <div class="wrap-slick2">
        <div class="slick2">
          ...
          <div class="item-slick2 p-l-15 p-r-15">
            ...
            <div class="block2">
              <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                <img src="<?php echo base_url() ?>assets/depan/images/item-02.jpg" alt="IMG-PRODUCT">
          ...
          <div class="item-slick2 p-l-15 p-r-15">
            ...
            <div class="block2">
              <div class="block2-img wrap-pic-w of-hidden pos-relative">
                <img src="<?php echo base_url() ?>assets/depan/images/item-03.jpg" alt="IMG-PRODUCT">
          ...
          <div class="item-slick2 p-l-15 p-r-15">
            ...
            <div class="block2">
              <div class="block2-img wrap-pic-w of-hidden pos-relative">
                <img src="<?php echo base_url() ?>assets/depan/images/item-05.jpg" alt="IMG-PRODUCT">
          ...
          <div class="item-slick2 p-l-15 p-r-15">
            ...
            <div class="block2">
              <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
                <img src="<?php echo base_url() ?>assets/depan/images/item-07.jpg" alt="IMG-PRODUCT">
      ...
      <div class="row">
        <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
          <div class="hov-img-zoom pos-relative">
            <img src="<?php echo base_url() ?>assets/depan/images/ananda6.jpg" alt="IMG-BANNER">
        ...
        <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
          <div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
            <img src="<?php echo base_url() ?>assets/depan/images/shop-item-09.jpg" alt="IMG-BANNER">
  ...
  <section class="instagram p-t-20">
    ...
    <div class="flex-w">
      ...
      <div class="block4 wrap-pic-w">
        <img src="<?php echo base_url() ?>assets/depan/images/gallery-03.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?php echo base_url() ?>assets/depan/images/gallery-07.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?php echo base_url() ?>assets/depan/images/gallery-09.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?php echo base_url() ?>assets/depan/images/gallery-13.jpg" alt="IMG-INSTAGRAM">
      ...
      <!-- Block4 -->
      <div class="block4 wrap-pic-w">
        <img src="<?php echo base_url() ?>assets/depan/images/gallery-15.jpg" alt="IMG-INSTAGRAM">
