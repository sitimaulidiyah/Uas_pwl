...
class Profile extends CI_Controller
{
    ...
    public function index()
    {
        $data['title'] = "Profile";
        $data['user'] = $this->user;
        $this->template->load('penjual/dashboard', 'penjual/profile/user', $data);
    }
    ...
    public function setting()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "Profile";
            $data['user'] = $this->user;
            $this->template->load('penjual/dashboard', 'penjual/profile/setting', $data);
        } else {
            ...
            if (empty($_FILES['foto']['name'])) {
                ...
                redirect('penjual/profile/setting');
            } else {
    ...
    public function ubahpassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('penjual/dashboard', 'penjual/profile/ubahpassword', $data);
        } else {
            $input = $this->input->post(null, true);
            ...
            redirect('penjual/profile/ubahpassword');
        }
    }
}
